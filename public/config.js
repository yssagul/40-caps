...
export const CONFIG = {
  ...
  // Chip rendering details
  CHIP_SHADOW_OFFSET: 2,
  CHIP_CENTER_DOT_RADIUS: 5,
  SELECTION_RING_PAD: 6,
  ELIGIBLE_PULSE_PAD: 4,

  // Networking
  NET_RECONNECT_DELAY: 2000,
  PHYSICS_STREAM_INTERVAL: 66,

  // Collision groups (Rapier membership|filter bitmasks)
  COLLISION_GROUP_WALLS: 0x0001ffff,
  COLLISION_GROUP_CHIPS: 0x0002ffff,
  COLLISION_GROUP_JUMP_SHOT: 0x00020001,

  // Phase groups (for conditional checks)
  PHASES_INTERACTIVE: ["SELECTING_CHIP", "FLICK_ANGLE", "FLICK_POWER"],
  PHASES_FLICKING: ["FLICK_ANGLE", "FLICK_POWER", "FLICK_ANIMATING"],
  PHASES_DOUBLE_VISION: ["FLICK_ANGLE", "FLICK_POWER", "FLICK_ANIMATING", "SELECTING_CHIP"],
  PHASES_BLACKOUT: ["FLICK_ANGLE", "FLICK_POWER", "SELECTING_CHIP"],
